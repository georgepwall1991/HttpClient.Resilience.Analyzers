...
- `HCR004` for typed clients injected into singleton services, including nullable constructor parameters, singleton factory service-provider resolutions, visible `IServiceCollection` receiver validation, and namespace-aware qualified registration matching.
