...
- `HCR003` for factory-created clients cached through assignments or initializers into static fields or known singleton fields, including qualified singleton registrations.
...
- `HCR080` for obvious unbounded `Task.WhenAll` HTTP fan-out, with bounded-concurrency and connection-limit exclusions.
