...
```xml
<PackageReference Include="HttpClient.Resilience.Analyzers" Version="0.1.194" PrivateAssets="all" />
```
...
<Project>
  <ItemGroup>
    <PackageReference Include="HttpClient.Resilience.Analyzers" Version="0.1.194">
