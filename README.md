...
```xml
<PackageReference Include="HttpClient.Resilience.Analyzers" Version="0.1.201" PrivateAssets="all" />
```
...
<Project>
  <ItemGroup>
    <PackageReference Include="HttpClient.Resilience.Analyzers" Version="0.1.201">
