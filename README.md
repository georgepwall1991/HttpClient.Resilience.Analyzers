...
```xml
<PackageReference Include="HttpClient.Resilience.Analyzers" Version="0.1.169" PrivateAssets="all" />
```
...
<Project>
  <ItemGroup>
    <PackageReference Include="HttpClient.Resilience.Analyzers" Version="0.1.169">
