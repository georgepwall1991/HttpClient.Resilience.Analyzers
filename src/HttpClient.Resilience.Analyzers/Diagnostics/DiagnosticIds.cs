...
{
    public const string HCR001 = "HCR001";
    public const string HCR002 = "HCR002";
    ...
    public const string HCR043 = "HCR043";
    public const string HCR060 = "HCR060";
    public const string HCR061 = "HCR061";
