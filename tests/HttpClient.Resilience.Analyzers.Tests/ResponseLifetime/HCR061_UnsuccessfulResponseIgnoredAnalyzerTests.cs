...
public sealed class HCR061_UnsuccessfulResponseIgnoredAnalyzerTests
{
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenContentAliasIsReadBeforeSuccessIsChecked()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task DoesNotReport_WhenContentAliasIsReassignedBeforeRead()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenAssignedContentAliasIsReadBeforeSuccessIsChecked()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task DoesNotReport_WhenContentAliasPredatesAssignedResponse()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenChainedContentAliasIsReadBeforeSuccessIsChecked()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
            ...
            public sealed class Client
            {
                public async Task<string> GetAsync(HttpClient client, CancellationToken cancellationToken)
                {
                    var response = await client.GetAsync("https://example.com", cancellationToken);
                    var content = response.Content;
                    var contentAlias = content;
                    return await contentAlias.ReadAsStringAsync(cancellationToken);
                }
            }
            """;
    ...
    [Fact]
    public async Task DoesNotReport_WhenChainedContentAliasSourceIsReassignedBeforeCopy()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenContentAliasIsAssignedBackThroughEarlierAlias()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenContentIsReadThroughAssignedResponseAlias()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task DoesNotReport_WhenAssignedResponseAliasChecksSuccessBeforeContentRead()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task DoesNotReport_WhenResponseAliasAssignmentPredatesResponseAcquisition()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenContentIsReadThroughChainedResponseAlias()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
            ...
            public sealed class Client
            {
                public async Task<string> GetAsync(HttpClient client, CancellationToken cancellationToken)
                {
                    ...
                    return await secondAlias.Content.ReadAsStringAsync(cancellationToken);
                }
            }
            """;
    ...
    [Fact]
    public async Task DoesNotReport_WhenChainedResponseAliasChecksSuccessBeforeContentRead()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
            ...
            public sealed class Client
            {
                public async Task<string> GetAsync(HttpClient client, CancellationToken cancellationToken)
                {
                    ...
                    var firstAlias = response;
                    var secondAlias = firstAlias;
                    secondAlias.EnsureSuccessStatusCode();
                    return await secondAlias.Content.ReadAsStringAsync(cancellationToken);
                }
            }
            """;
    ...
    [Fact]
    public async Task DoesNotReport_WhenChainedResponseAliasSourceIsReassignedBeforeCopy()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenResponseAliasIsAssignedBackThroughEarlierAlias()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
            ...
            public sealed class Client
            {
                public async Task<string> GetAsync(HttpClient client, CancellationToken cancellationToken)
                {
                    ...
                    return await firstAlias.Content.ReadAsStringAsync(cancellationToken);
                }
            }
            """;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenNullForgivingContentIsRead()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenNullForgivingResponseContentIsRead()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenNullForgivingContentAliasIsRead()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task DoesNotReport_WhenNullForgivingResponseChecksSuccessBeforeContentRead()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
