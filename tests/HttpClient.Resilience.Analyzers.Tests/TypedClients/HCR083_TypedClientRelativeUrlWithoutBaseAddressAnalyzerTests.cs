...
public sealed class HCR083_TypedClientRelativeUrlWithoutBaseAddressAnalyzerTests
{
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenRegisteredTypedClientUsesNullForgivingRelativeUrl()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenRelativeStringLocalIsSelfAssigned()
    {
        const string source = """
            using System.Net.Http;
            using System.Threading;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenNullForgivingInlineRequestConstructorUsesRelativeUri()
    {
        const string source = """
            using System;
            using System.Net.Http;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenOnlyShadowedBuilderLocalIsConfigured()
    {
        const string source = """
            using System;
            using System.Net.Http;
            ...
            public static class Registrations
            {
                public static void Configure(IServiceCollection services)
                {
                    ...
                    void ConfigureOther()
                    {
                        var builder = services.AddHttpClient<OtherClient>();
                        builder.ConfigureHttpClient(client => client.BaseAddress = new Uri("https://other.example"));
                    }
            ...
            public sealed class PaymentsClient(HttpClient client)
            {
                ...
                {
                    return client.GetAsync("/payments");
                }
            }

            public sealed class OtherClient(HttpClient client)
            {
            }
            ...
            public static class ServiceCollectionExtensions
            {
                ...
                public static IHttpClientBuilder ConfigureHttpClient(
                    this IHttpClientBuilder builder,
                    Action<HttpClient> configure) => builder;
            }
            """;
    ...
    [Fact]
    public async Task DoesNotReport_WhenBaseAddressIsConfiguredThroughTopLevelBuilderLocal()
    {
        const string source = """
            using System;
            using System.Net.Http;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenTopLevelBuilderLocalOmitsBaseAddress()
    {
        const string source = """
            using System;
            using System.Net.Http;
    ...
    [Fact]
    public async Task ReportsDiagnostic_WhenTopLevelBuilderConfigurationIsDeferredInAnonymousMethod()
    {
        const string source = """
            using System;
            using System.Net.Http;
            ...
            IServiceCollection services = null!;
            var builder = services.AddHttpClient<PaymentsClient>();
            Action configureLater = delegate
            {
                builder.ConfigureHttpClient(client => client.BaseAddress = new Uri("https://api.example.com"));
            };
