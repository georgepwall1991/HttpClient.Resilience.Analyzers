---
title: HCR064 — Pass CancellationToken to HttpClient APIs
description: Outbound HTTP calls that ignore an available CancellationToken keep running after the caller disconnects.
---
