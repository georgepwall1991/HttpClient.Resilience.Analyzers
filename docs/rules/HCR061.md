---
title: HCR061 — Check HTTP success before reading response content
description: Reading HttpContent before IsSuccessStatusCode or EnsureSuccessStatusCode can treat error payloads as valid data.
---
