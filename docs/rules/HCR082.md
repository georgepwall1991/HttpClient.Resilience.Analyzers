---
title: HCR082 — Avoid per-request resilience pipeline construction
description: Building a Polly ResiliencePipeline on every HTTP call allocates and can skip shared handler configuration.
---
