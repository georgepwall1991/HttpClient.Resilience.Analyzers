---
title: HCR083 — Configure BaseAddress for typed clients using relative URLs
description: Typed HttpClient calls with relative URLs fail at runtime when AddHttpClient did not set BaseAddress.
---
