---
title: HCR040 — Do not stack duplicate resilience handlers
description: Detects stacked AddStandardResilienceHandler or same-name Polly handlers that double-retry or double-timeout one HttpClient.
---
