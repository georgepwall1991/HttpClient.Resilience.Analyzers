---
title: HCR003 — Do not cache IHttpClientFactory.CreateClient() results
description: Detects factory-created HttpClient instances stored in static or singleton fields, defeating IHttpClientFactory rotation.
---
