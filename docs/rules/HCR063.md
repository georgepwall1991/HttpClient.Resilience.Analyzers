---
title: HCR063 — Avoid sync-over-async around outbound HTTP
description: Blocking on HttpClient tasks with Result, Wait, or GetAwaiter().GetResult() can starve the thread pool under load.
---
