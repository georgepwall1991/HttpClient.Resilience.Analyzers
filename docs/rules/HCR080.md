---
title: HCR080 — Bound high-concurrency HttpClient fan-out
description: Unbounded Task.WhenAll over HttpClient calls can exhaust sockets; prefer bounded concurrency or MaxConnectionsPerServer.
---
