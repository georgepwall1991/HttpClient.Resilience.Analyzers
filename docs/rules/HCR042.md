---
title: HCR042 — AddStandardHedgingHandler replaying unsafe HTTP methods
description: Warns when standard hedging concurrently replays POST, PUT, PATCH, DELETE, or CONNECT unless the operation is idempotent.
---
