---
title: HCR005 — Duplicate AddHttpClient typed-client registrations
description: Flags separately registering a typed client that AddHttpClient<T>() already registered, causing conflicting HttpClient configuration.
---
