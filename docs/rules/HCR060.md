---
title: HCR060 — Dispose HttpResponseMessage with ResponseHeadersRead
description: ResponseHeadersRead returns before the body finishes; failing to dispose the HttpResponseMessage can stall the connection pool.
---
