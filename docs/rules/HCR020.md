---
title: HCR020 — DelegatingHandler should not capture scoped request data
description: DelegatingHandler instances are often long-lived; capturing HttpContext or scoped services can leak data across requests.
---
