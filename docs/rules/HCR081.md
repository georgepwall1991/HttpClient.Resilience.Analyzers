...
The code fix converts a simple single-variable local declaration to `using var`. It is not offered for later assignments because changing an existing local's ownership scope requires broader control-flow judgment.
