...
| `HCR020` | Yes | Guide | High-confidence request-scoped and known scoped service constructor dependencies in handlers, including namespace-aware qualified and nullable scoped service names plus lookalike qualified handler-base filtering. |
