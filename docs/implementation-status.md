...
| `HCR002` | Yes | Yes | Static or singleton-owned manual field/property client initializers and assignments without `PooledConnectionLifetime`, including resolved custom client filtering, recognition for configured handler locals/fields/properties, namespace-aware qualified singleton registrations, and visible singleton factory registrations that construct implementations; code fix is limited to safe parameterless field initializers. |
