...
```xml
<PackageReference Include="HttpClient.Resilience.Analyzers" Version="0.1.178" PrivateAssets="all" />
```
...
<Project>
  <ItemGroup>
    <PackageReference Include="HttpClient.Resilience.Analyzers" Version="0.1.178">
