...
3. Review `HCR040`, `HCR041`, `HCR042`, `HCR060`, `HCR061`, `HCR062`, `HCR063`, `HCR064`, `HCR081`, `HCR082`, `HCR083`, `HCR084`, and `HCR085` first. These are intentionally kept visible in the brownfield profile because they point at retry, hedging, request/response-handling, and typed-client configuration risks that can create incidents.
...
For large services, start with `HCR041`, `HCR042`, `HCR060`, `HCR061`, `HCR062`, `HCR063`, `HCR064`, `HCR081`, `HCR082`, `HCR083`, `HCR084`, and `HCR085` in the most critical outbound paths, then work through lifetime and DI findings.
