...
3. Review `HCR040`, `HCR041`, `HCR060`, `HCR061`, `HCR062`, `HCR063`, `HCR064`, and `HCR081` first. These are intentionally kept visible in the brownfield profile because they point at retry and request/response-handling risks that can create incidents.
...
For large services, start with `HCR041`, `HCR060`, `HCR061`, `HCR062`, `HCR063`, `HCR064`, and `HCR081` in the most critical outbound paths, then work through lifetime and DI findings.
