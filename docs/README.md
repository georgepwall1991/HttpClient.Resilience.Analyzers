...
| [Analyzer health](analyzer-health.md) | Evidence-backed rule scorecard, throughput guardrails, and 30-iteration improvement backlog. |
...
- [Resilience rules](rules/README.md#resilience): `HCR040`, `HCR041`, `HCR042`, `HCR043`, `HCR082`
